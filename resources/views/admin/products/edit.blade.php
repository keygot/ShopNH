    ...
    <div class="col-md-12">
        ...
        <div class="tile">
            ...
            <div class="tile-body">
                ...
                <form class="row" method="POST" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-4">
                        <div class="form-group col-md-12">
                            <label class="control-label">Tên sản phẩm</label>
                            <input class="form-control" value="{{ old('name') ?? $product->name }}" name="name" type="text">
                            @error('name')
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div id="thumbbox">
                                <img height="300" width="300" alt="Thumb image" id="thumbimage" src="{{$product->images ? asset('upload/' .$product->images->url) : 'upload/default.jpg'}}">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" value="{{ old('price') ?? $product->price }}" name="price" type="text">
                            @error('price')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" name="sale" type="text" value="{{ old('sale') ?? $product->sale }}">
                            @error('sale')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control" name="description" id="description" type="text">{{ old('description') ?? $product->description }}</textarea>
                            @error('description')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control" name="category_id[]" id="exampleSelect1" multiple style="min-height: 140px;">
