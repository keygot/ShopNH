    ...
    <div class="col-md-12">
        ...
        <div class="tile">
            ...
            <div class="tile-body">
                ...
                <form class="row" method="POST" action="{{ route('coupons.store') }}">
                    @csrf
                    <div class="col-4">
                        <div class="form-group col-md-12">
                            <label class="control-label">Name</label>
                            <input class="form-control" value="{{ old('name') }}" name="name" type="text" style="text-transform: uppercase;">
                            @error('name')
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" value="{{ old('value') }}" name="value" type="number">
                            @error('value')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" value="{{ old('expery_date') }}" name="expery_date" type="date">
                            @error('expery_date')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
