                ...
                <form class="row" method="POST" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="col-4">
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" value="{{ old('name') ?? $user->name }}" name="name" type="text">
                            @error('name')
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div id="thumbbox">
                                <img height="300" width="300" alt="Thumb image" id="thumbimage" src="{{$user->images ? asset('upload/' .$user->images->url) : 'upload/default.jpg'}}">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" value="{{ old('email') ?? $user->email }}" name="email" type="email">
                            @error('email')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" value="{{ old('phone') ?? $user->phone }}" name="phone" type="text">
                            @error('phone')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control" name="address" type="text">{{ old('address') ?? $user->address }}</textarea>
                            @error('address')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control" name="gender" id="exampleSelect1" value="{{$user->gender}}">
