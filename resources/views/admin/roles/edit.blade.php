...
@section('title', 'Chỉnh sửa quyền truy cập' .$role->name)
                ...
                <form class="row" method="POST" action="{{ route('roles.update', $role->id) }}">
                    ...
                    <div class="col-4">
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" value="{{ old('name') ?? $role->name}}" name="name" type="text"
                                >
                            @error('name')
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" value="{{ old('display_name') ?? $role->display_name}}" name="display_name" type="text"
                                >
                            @error('display_name')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control" name="group" id="exampleSelect1" value="{{$role->group}}">
